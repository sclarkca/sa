...
@Entity
@Table(name = "biz_app_url")
public class AppUrl implements Resource {
	 ...
	 * @return children
	 */
	public List<AppUrl> getChildren() {
		return children;
	}

	public void setChildren(List<AppUrl> children) {
