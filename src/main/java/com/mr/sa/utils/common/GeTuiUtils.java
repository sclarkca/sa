...
public class GeTuiUtils {
    ...
    public void pushToSingleByCid(String cid, String title, String content) {
        ...
        log.info("推送信息：pushDTO={}", JSON.toJSONString(pushDTO));
        ApiResult<Map<String, Map<String, String>>> apiResult = pushApi.pushToSingleByCid(pushDTO);
        if (apiResult.isSuccess()) {
            // success
            log.info(apiResult.getMsg(), apiResult.getData());
        } else {
            // failed
     ...
     * @param content
     */
    public void pushListByCid(List<String> cidList, String title, String content) {
        //批量发送
    ...
    private PushDTO<Audience> buildPushDTO(String title, String content) {
        ...
        notification1.setIntent("intent:#Intent;action=android.intent.action.oppopush;launchFlags=0x14000000;component=cn.union.jianye/io.dcloud.PandoraEntry;S.UP-OL-SU=true;S.title=" + title + ";S.content=" + content + ";S.payload=test;end");
        //各厂商自有功能单项设置
