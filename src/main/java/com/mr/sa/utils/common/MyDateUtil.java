...
public class MyDateUtil {
    ...
    public static String transfer2(Long time) {
        String s = String.format("%d", time % 60);
        String m = String.format("%d", (time / 60) % 60);
        String h = String.format("%d", time / 3600); //每天 86400 秒
     ...
     * @return 格式后的日期 yyyy-MM-dd
     */
    public static Date parseToDay1(String strDate) {
    ...
    public static long getTwoDay(Date sj1, Date sj2) {
        long day = 0;
        try {
            day = (sj2.getTime() - sj1.getTime()) / (24 * 60 * 60 * 1000);
        } catch (Exception e) {
            log.info("Exception", e);
            return 0L;
        }
    ...
    // Date+Time
    public static Date plusDayTime(Date startDate, Date startTime) {
        String startDateStr = formatToDay(startDate);
        String startTimeStr = formatToHHmmss(startTime);
        Date dateTime = parserToSecond(startDateStr + " " + startTimeStr);
        return dateTime;
    }
}
